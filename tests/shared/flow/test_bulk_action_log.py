...
class TestBulkActionLogDecorator:
    ...
    def test_logs_event_with_filter_mode(self, monkeypatch, tmp_path, caplog):
        """
    ...
    def test_logs_payload_is_not_in_record(self, monkeypatch, tmp_path, caplog):
        """
    ...
    def test_logs_event_even_on_validation_error(self, monkeypatch, tmp_path, caplog):
        """
