...
class TestSplitAdminPages:
    def test_orders_page_blocks_unauthenticated(self, monkeypatch, tmp_path):
        """
        Given no auth token,
    ...
    def test_inquiries_page_blocks_unauthenticated(self, monkeypatch, tmp_path):
        """
        Given no auth token,
    ...
    def test_orders_template_renders(self, monkeypatch, tmp_path):
        """
    ...
    def test_inquiries_template_renders(self, monkeypatch, tmp_path):
        """
    ...
    def test_legacy_requests_route_is_gone(self, monkeypatch, tmp_path):
        """
