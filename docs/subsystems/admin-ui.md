...
| Inquiries | `/admin/inquiries/` | `ordering/templates/ordering/pages/inquiries.html` |
| Orders (feature-gated) | `/admin/orders/` | `ordering/templates/ordering/pages/orders.html` |
